...
\begin{frame}{\large Is the Impossible Trinity of Modeling \textbf{solved}?}
    ...
    \visible<3->{
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north west, xshift=0.30cm, yshift=-5.5cm] at (current page.north west) {\includegraphics[width=0.05\textwidth]{../figs/pirom/checkmark.png}};
    \end{tikzpicture}}
    \visible<6->{
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north west, xshift=3.64cm, yshift=-5.5cm] at (current page.north west) {\includegraphics[width=0.05\textwidth]{../figs/pirom/checkmark.png}};
    \end{tikzpicture}}
\end{frame}