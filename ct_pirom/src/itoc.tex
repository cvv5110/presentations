...
\begin{frame}{\large \textbf{Step back from direct-shooting training} and consider a \textbf{control-theoretic} training,}
    \footnotesize
    \only<2>{
        \begin{figure}
            \centering
...
\begin{frame}{\large How can the \textbf{control-theoretic training} be used for optimal closed-loop control?}
    \visible<2->{
    \begin{center}
