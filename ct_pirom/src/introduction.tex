...
% \section{\large Motivation, Background, and Objectives}
...
\begin{frame}{\large We want \textbf{high-fidelity and efficient} \textbf{simulation and control} of hypersonic systems,}
    \footnotesize
    \only<2>{
        \begin{figure}
            \centering
...
\begin{frame}{\large ITM: balancing \textbf{accuracy, efficiency, and generalizability} with little data,}
    \footnotesize
    \begin{columns}
...
\begin{frame}{\large ITOC: balancing \textbf{accuracy, efficiency, and generalizability} with little data,}
    \footnotesize
    \begin{columns}
        \begin{column}{0.65\textwidth}
            \only<1-2>{
...
\begin{frame}{\large Objectives of research are \textbf{to solve the ITM and ITOC simultaneously},}
    \footnotesize
    \only<1>{
        \begin{figure}
            \centering
