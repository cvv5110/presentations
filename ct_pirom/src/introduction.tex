...
% \section{\small Motivation, Background, and Objectives}
...
% \begin{frame}{\small Motivation: Simulation and Control of Hypersonic Systems}
%     \footnotesize
%     \begin{columns}
...
\begin{frame}{\small We want \textbf{high-fidelity} \textbf{simulation and optimal control} of hypersonic systems,}
    \footnotesize
    \only<2>{
        \begin{figure}
            \centering
...
\begin{frame}{\small How can we balance \textbf{accuracy, efficiency, and generalizability} with little data?}
    ...
    \begin{columns}
        ...
        \begin{column}{0.46\textwidth}
            ...
            \begin{itemize}
                \item<4-> \textbf{FEMs}: too many states,
                \item<5-> \textbf{RPMs}: overly simplified problems,
                \item<6-> \textbf{NNs}: need too much data,
            \end{itemize}
        \end{column}
    \end{columns}
    \visible<2->{
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item<4-> \textbf{NNs}: biased towards training data,
...
\begin{frame}{\small The objectives of this research are \textbf{to solve the ITM and ITOC simultaneously},}
    \footnotesize
    \only<1>{
        \begin{figure}
            \centering
