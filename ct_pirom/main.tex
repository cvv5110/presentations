...
% part 2: itm
\input{./src/itm.tex}
% \input{./src/itm_part_3.tex}

% % part 3: bridge: control-theoretic training
% \input{./src/control_theoretic.tex}

% % part 4: resolving the impossible trinity of optimal control (ITOC)
% \input{./src/itoc_part_1.tex}
% \input{./src/itoc_part_2.tex}
% \input{./src/itoc_part_3.tex}
