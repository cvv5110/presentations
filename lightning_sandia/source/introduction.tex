...
\begin{frame}{\small Persistent issues with \textbf{state-of-the-art} approaches,}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_4.png}{\tiny [1]}
    \end{figure}}
    \only<5>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_5.png}{\tiny [1]}
    \end{figure}}
    \only<6>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_6.png}{\tiny [1]}
    \end{figure}}
    \only<7>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_7.png}{\tiny [1]}
    \end{figure}}
    \only<8>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_8.png}{\tiny [1]}
    \end{figure}}
    \only<9>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_9.png}{\tiny [1]}
    \end{figure}}
    \only<10>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_10.png}{\tiny [1]}
    \end{figure}}
    \only<11>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_11.png}{\tiny [1]}
    \end{figure}}
    \only<12>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_12.png}{\tiny [1]}
    \end{figure}}
    \only<13>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_13.png}{\tiny [1]}
    \end{figure}}
    \only<14>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_14.png}{\tiny [1]}
    \end{figure}}
    \only<15>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/physics_informed_15.png}{\tiny [1]}
    \end{figure}}
    \begin{center}
