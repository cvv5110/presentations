...
\begin{frame}{\small Persistent issues with \textbf{state-of-the-art} approaches,}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_1.png}
    \end{figure}}
    \only<2>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_2.png}
    \end{figure}}
    \only<3>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_3.png}
    \end{figure}}
    \only<4>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_4.png}{\tiny [1]}
    \end{figure}}
    \only<5>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_5.png}{\tiny [1]}
    \end{figure}}
    \only<6>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_6.png}{\tiny [1]}
    \end{figure}}
    \only<7>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_7.png}{\tiny [1]}
    \end{figure}}
    \only<8>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_8.png}{\tiny [1]}
    \end{figure}}
    \only<9>{
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../figs/sota/pi_9.png}{\tiny [1]}
    \end{figure}}
    \begin{center}
