...
\begin{frame}{{\small \textbf{High-Fidelity} design optimization is costly,}}
    \footnotesize
    \vspace*{-0.1in}
    \only<1>{
        \begin{figure}
...
\begin{frame}{\small Persistent issues with \textbf{SoTA} approaches,}
    \vspace*{-0.2in}
    \footnotesize
    \only<2>{
    \begin{figure}
    ...
    \end{figure}}
    \begin{center}
        {\tiny GE: governing equations, BC: boundary conditions, IC: initial conditions, OBS: observable, NN: neural network, SoTA: state-of-the-art}
    \end{center}
\end{frame}
