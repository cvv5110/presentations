\begin{frame}
    \vspace*{1.3in}
    \begin{center}
        \Large \textbf{Results}: Modeling Hypersonic TPS
    \end{center}
\end{frame}

\begin{frame}{\small Start with the following \textbf{parametrization},}
    \vspace*{-0.2in}
    \footnotesize
    \begin{columns}
        \visible<1->{
...
\begin{frame}{\small \textbf{Extrapolate} to boundary conditions and material properties,}
    \vspace*{-0.2in}
    \footnotesize
    \only<2>{
        \begin{figure}
...
\begin{frame}{\small Is the Impossible Trinity of Modeling \textbf{solved}?}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north west, xshift=1.97cm, yshift=-2.9cm] at (current page.north west) {\includegraphics[width=0.05\textwidth]{../figs/pirom/checkmark.png}};
    \end{tikzpicture}}
    \visible<3->{
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north west, xshift=0.34cm, yshift=-4.95cm] at (current page.north west) {\includegraphics[width=0.05\textwidth]{../figs/pirom/checkmark.png}};
    \end{tikzpicture}}
    \visible<6->{
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north west, xshift=3.65cm, yshift=-4.95cm] at (current page.north west) {\includegraphics[width=0.05\textwidth]{../figs/pirom/checkmark.png}};
    \end{tikzpicture}}
\end{frame}