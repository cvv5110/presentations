\documentclass[NM,relaxedfont,theme=angles,number=2026]{sandia-beamer}
...
\title{Physics-Infused Reduced-Order Modeling}
\subtitle{An Application to Hypersonic Thermal Protection Systems}
