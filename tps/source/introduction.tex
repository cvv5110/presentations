...
\begin{frame}{\small We would like to perform \textbf{analysis}, \textbf{design}, and \textbf{optimization} of hypersonic systems,}
    \footnotesize
    \vspace*{-0.1in}
    \only<2>{
        \begin{figure}
...
\begin{frame}{\small However, balancing \textbf{accuracy}, \textbf{efficiency}, and \textbf{generalizability} is challenging,}
    \footnotesize
    \begin{columns}
        ...
        \begin{column}{0.50\textwidth}
            ...
            \end{center}}
            \begin{itemize}
                \item<3-> \textbf{FEM}: too many states,
    ...
    \begin{center}
        \vspace*{0.05in}
        \tiny ITM: impossible trinity of modeling, FEM: finite-element model, RPMs: reduced-order models, NNs: neural networks
    \end{center}}
\end{frame}
